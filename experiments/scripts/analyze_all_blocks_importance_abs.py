...
def plot_block_distributions(block_name, block_params, output_path):
    ...
    for idx, param_name in enumerate(param_names):
        ...
        ax.set_xlabel('Importance Score (Absolute)', fontsize=11)
    ...
    # 设置总标题
    fig.suptitle(f'{block_name.replace("_", " ").title()} - Absolute Importance Distribution',
...
def main():
    ...
    parser = argparse.ArgumentParser(description='使用绝对值重要性为每个 block 生成分布图')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='results/blocks_importance_abs',
                        help='输出目录')
    ...
    print("=" * 80)
    print("GPT-2 所有 Blocks 的参数重要性分布分析（绝对值版本）")
    print("=" * 80)
    ...
    for block_name in blocks_to_plot:
        ...
        output_path = output_dir / f'{block_name}_importance_abs.png'
